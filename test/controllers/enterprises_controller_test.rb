...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference("Enterprise.count") do
      post enterprises_url, params: { enterprise: { address: @enterprise.address, email: @enterprise.email, name: @enterprise.name, phone: @enterprise.phone } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { address: @enterprise.address, email: @enterprise.email, name: @enterprise.name, phone: @enterprise.phone } }
